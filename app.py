...
<style>
    ...
    /* Tab-uri — segmented control iOS */
    .stTabs [data-baseweb="tab-list"] {
        gap: 0; background: #E9E9EB; border-radius: 10px; padding: 2px;
        width: fit-content;
    }
    .stTabs [data-baseweb="tab"] {
        border-radius: 8px; padding: 7px 18px; background: transparent;
        font-weight: 600; font-size: .88rem; color: #000; border: none;
    }
    .stTabs [aria-selected="true"] {
        background: #FFFFFF !important; color: #000 !important;
        box-shadow: 0 1px 3px rgba(0,0,0,.10), 0 0.5px 1px rgba(0,0,0,.06);
    }
...
#  TAB-URI
# ======================================================================
tab_sim, tab_sens, tab_cmp, tab_val, tab_exp = st.tabs(
    ["📊 Simulare", "🎯 Sensibilitate", "⚖️ Comparație A/B", "✅ Validare", "📄 Export PDF"])
...
# ----------------------------------------------------------------------
with tab_cmp:
    st.markdown("#### ⚖️ Comparație vehicul A vs vehicul B")
